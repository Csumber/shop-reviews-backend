...
export namespace GetProductReviewData {
  export type Variables = GetProductReviewDataQueryVariables;
  export type Query = GetProductReviewDataQuery;
  export type Product = (NonNullable<GetProductReviewDataQuery['product']>);
  export type CustomFields = (NonNullable<(NonNullable<GetProductReviewDataQuery['product']>)['customFields']>);
}
...
export type GetProductReviewDataQueryVariables = {
  id: Scalars['ID']
};


export type GetProductReviewDataQuery = (
  { __typename?: 'Query' }
  & { product: Maybe<(
    { __typename?: 'Product' }
    & Pick<Product, 'id'>
